...
infoText = ['Amicizia per Caramella', 'Passiva', 'Riduzione di Costo', 'Costi di un Uovo', 'Abilità Speciale', 
            'Solo da Uovo', 'Solo Baby', 'Pokémon Paradosso', 'Cambio Forma', 'Biomi', 'Filtri',
            'Ridotto dopo ## uova', 'per Livello', 'da Uovo', 'per MT', 'Set di mosse', 'Info']
...
phrases = {
    ...
    'typeImmunity': 'Immunità {type}',
    'rainSynergy': 'Sinergia Pioggia',
    'sandSynergy': 'Sinergia Sabbia',
    'snowSynergy': 'Sinergia Neve',
    'sunSynergy': 'Sinergia Sole',
    'createsRain': 'Crea Pioggia',
    'createsSand': 'Crea Sabbia',
    'createsSun': 'Crea Sole',
    'cantBeSuppressed': 'Non può essere annullata',
    'cantBeReplaced': 'Non può essere sostituita',
    'cantBeIgnored': 'Non può essere ignorata',
