...
tagToDesc = [
    ...
    "Cible : Tous les enemies",
    "Cible : Tous les Pokémon",
    "Affecté par Sans Limite",
    ...
    "Le lanceur ne peut pas se retirer",
    "La cible ne peut pas se retirer",
    "Immunité Électrik",
    "Immunité Feu",
    "Immunité Sol",
    "Immunité Eau",
    "Immunité à Intimidation",
    "Synergie Pluie",
    "Invoque Pluie",
    "Synergie Sable",
    "Invoque Sable",
    ...
    "Talent Parfum", # or "Talent d’Appât"
    "Contact",
